...
public class SpartanWithXML extends SpartanAuthTestBase {
    ...
    public void getSpartanXml() {
        ...
        .when()
         ...
         .then()
                ...
                //i changed myself application/xml;charset=UTF-8
                .body("List.item[0].name",is("Tom"))  //Meade it was i changed
    ...
    public void testXmlPath(){
        ...
        //get fourth spartan name
        String name2 = xmlPath.getString("List.item[3].name");//4. item in adi  index 0 dan basladigindan
        System.out.println("name = " + name2);//name = Paige
