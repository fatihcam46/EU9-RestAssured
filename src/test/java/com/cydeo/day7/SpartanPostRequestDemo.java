 ...
 */
       ...
       public void postMethod3() {
              ...
              //i need to convert to JSON

              System.out.println("spartan = " + spartan);
//spartan = Spartan(id=0, name=SeverusSpartan, gender=Male, phone=8877445596)
       ...
       public void postMethod4(){
              ...
              System.out.println("spartan = " + spartan);
              //spartan = Spartan(id=0, name=BruceWayne, gender=Male, phone=8877445596)
              String expectedResponseMessage = "A Spartan is Born!";
              ...
              int idFromPost = given().accept(ContentType.JSON).and() //what we are asking from api which is JSON response
                      ...
                      .extract().jsonPath().getInt("data.id");//return integer
