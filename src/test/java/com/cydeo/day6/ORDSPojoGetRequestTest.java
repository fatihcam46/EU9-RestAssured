...
//     System.out.println("region1.getRegion_name() = " + region1.getRegion_name());
 //       System.out.println("region1.getLinks().get(0).getHref() = " + region1.getLinks().get(0).getHref());
    ...
    @DisplayName("GET request to /employees and only get couple of values as a Pojo class")//from POSTMON
    @Test
...
//Employee(firstName=Steven, lastName=King, jobId=AD_PRES, salary=24000)
    }
    ...
    public void regionPojoTest() {
        ...
        Regions regions = get("/regions").then().statusCode(200).extract().response().as(Regions.class);//as method
